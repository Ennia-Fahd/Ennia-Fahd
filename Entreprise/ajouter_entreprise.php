...
<div  id="PathToFile" style="display:inline-flex;position: relative; top: 14%">
       <?php if(isset($_GET["Ville"])){ ?>
        ...
        <a href="../../SiteEmsi/index.php?Ville=<?php echo $_GET["Ville"];?>">Accueil Centre Carrière de <?php echo ucfirst($_GET["Ville"]); ?></a>  <img  src="../Image/icons8-more-than-24.png" alt="">
...
<a href="../../SiteEmsi/Entreprise/Entreprise.php" >Entreprise</a>
    <?php
       ...
       ?>
        ...
        <img src="../Image/icons8-more-than-24.png" alt=""><p style="color: black; text-decoration: none; cursor:default;" >Ajouter Entreprise</p>
    </div>
...
<form id="animated-2" method="get" action="ajouter_entreprise.php">
...
if(isset($_GET["Ville"])){
?>
      <form id="survey-form" action="ajouter_entreprise.php?Ville=<?php echo $_GET['Ville']; ?>" method="Post">

<?php
}
else {
    ?>
                           <form id="survey-form" action="ajouter_entreprise.php" method="Post">
...
<fieldset>
  <legend>Entreprise</legend>
          ...
          <input class="input-field" type="text" id="name" name="Entreprise"  placeholder="entre le nom de l'entreprise..." required autofocus>

          <br>
          <label id="email"  for="email"> Email :</label>
          <input class="input-field" type="email" id="email" name="Email" placeholder="Email de l'entreprise.." required>
          <br>
          <label id="Tel"  for="Tel"> Téléphone :</label>
          <input class="input-field" type="Tel" id="Tel" name="Tel" pattern="0[5-7][0-9]{8}" placeholder="Téléphone de l'entreprise.." required>
          <br>
