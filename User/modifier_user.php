...
<div  id="PathToFile" style="display:inline-flex;position: relative; top: 14%">        
        ...
        <img src="../Image/icons8-more-than-24.png" alt=""><p style="color: black; text-decoration: none; cursor:default;">Ajouter Utilisateur </p>
    </div>
...
if(isset($_POST["id"])){
  ...
  echo "Veuillez selectionner un user";
}
if(isset($id)){

if(isset($_GET["recherche_user"])){
    ?>
<form id="animated-2" method="get" action="modifier_user.php">
...
?>
<form id="animated-2" method="get" action="modifier_user.php">
<div class="container" style="position :relative; margin-top: 40px; left: 10%;">
<?php if(isset($_GET["Ville"])) { ?><input type="hidden" name="Ville" value="<?php echo $_GET["Ville"]; ?>"> <?php } ?>
...
?>
<div class="container" >
      <form id="survey-form" action="modifier_user.php"   method="Post" enctype="multipart/form-data">
<fieldset>
  <legend>User</legend>
  <label  id="NomPrenom" for="NomPrenom">Nom et Prénom :</label>
          <input class="input-field" type="text"  name="NomPrenom"  value=<?php echo $user["Nom_Prenom"]; ?> placeholder="Nom et prénom..." required >
          <br>
          <label  id="Email" for="Email">Email :</label>
          <input class="input-field" type="text"  name="Email" value=<?php echo $user["Email"]; ?> placeholder="Email..." required >
          <br>
          ...
          <input class="input-field" type="text"  name="Pseudonyme" value=<?php echo $user["Pseudonyme"]; ?> placeholder="Pseudonyme..." required >
          <br>
